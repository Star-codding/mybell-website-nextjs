    ...
    <>
      ...
      >
        ...
        <a href="#">
          <div className="relative cursor-pointer">
            <img
              ...
              src="https://tailwind-ecommerce-demo.vercel.app/bedroom.ff2259bc.png"
        ...
        <a href="#">
          <div className="relative cursor-pointer">
            <img
              className="mx-auto h-auto w-auto brightness-50 duration-300 hover:brightness-100"
              src="https://tailwind-ecommerce-demo.vercel.app/matrass.244c24b1.png"
        ...
        <a href="#">
          <div className="relative cursor-pointer">
            <img
              className="mx-auto h-auto w-auto brightness-50 duration-300 hover:brightness-100"
              src="https://tailwind-ecommerce-demo.vercel.app/outdoors.1cb064f8.png"
        ...
        <a href="#">
          <div className="relative cursor-pointer">
            <img
              className="mx-auto h-auto w-auto brightness-50 duration-300 hover:brightness-100"
              src="https://tailwind-ecommerce-demo.vercel.app/product-bigsofa.69156cd0.png"
              alt="bedroom cathegory image"
            />
        ...
        <a href="#">
          <div className="relative cursor-pointer">
            <img
              className="mx-auto h-auto w-auto brightness-50 duration-300 hover:brightness-100"
              src="https://tailwind-ecommerce-demo.vercel.app/kitchen.0682dff9.png"
              alt="bedroom cathegory image"
            />
        ...
        <a href="#">
          <div className="relative cursor-pointer">
            <img
              className="mx-auto h-auto w-auto brightness-50 duration-300 hover:brightness-100"
              src="https://tailwind-ecommerce-demo.vercel.app/living-room.7116291f.png"
              alt="bedroom cathegory image"
            />
      ...
      >
        <div className="splide__track">
          ...
          <Slider {...settings}>
            <li className="splide__slide px-2">
            ...
            <li className="splide__slide px-2">
              <div className="flex flex-col">
                <img
                  className=""
                  src="https://tailwind-ecommerce-demo.vercel.app/product-sofa.b75d3d1f.png"
                  alt="Kitchen image"
                />
      ...
      <div className="mx-auto max-w-[1200px] px-5">
        ...
        >
          ...
          <img
            ...
            src="https://tailwind-ecommerce-demo.vercel.app/sale-bage.4d15c2f3.jpeg"
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <div>
            ...
            <div className="flex items-center">
              <svg
                xmlns="https://tailwind-ecommerce-demo.vercel.app/product-sofa.b75d3d1f.png"
                viewBox="0 0 20 20"
                fill="currentColor"
                className="h-4 w-4 text-yellow-400"
              >
        ...
        <div className="flex flex-col">
          <div className="relative flex">
            <img className="" src="https://tailwind-ecommerce-demo.vercel.app/kitchen.0682dff9.png" alt="kitchen image" />
            <div
              className="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100"
            >
              <a href="product-overview.html">
        ...
        <div className="flex flex-col">
          <div className="relative flex">
            <img className="" src="https://tailwind-ecommerce-demo.vercel.app/bedroom.ff2259bc.png" alt="Bedroom image" />
            <div
              className="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100"
            >
              <a href="product-overview.html">
