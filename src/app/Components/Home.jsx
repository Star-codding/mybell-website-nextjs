  ...
  return (
    <>
      ...
      >
        ...
        <div class="flex flex-col">
          <div class="relative flex">
            <img class="" src="https://tailwind-ecommerce-demo.vercel.app/kitchen.0682dff9.png" alt="kitchen image" />
            <div
              class="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100"
            >
              <a href="product-overview.html">
        ...
        <div class="flex flex-col">
          <div class="relative flex">
            <img class="" src="https://tailwind-ecommerce-demo.vercel.app/bedroom.ff2259bc.png" alt="Bedroom image" />
            <div
              class="absolute flex h-full w-full items-center justify-center gap-3 opacity-0 duration-150 hover:opacity-100"
            >
              <a href="product-overview.html">
